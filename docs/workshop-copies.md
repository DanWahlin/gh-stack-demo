...
This repository is a GitHub template and supports two isolated workshop modes. The Node.js setup script uses the same command in PowerShell, Command Prompt, Bash, and Zsh.
...
```sh
git clone https://github.com/DanWahlin/learn-github-stacked-prs.git
node learn-github-stacked-prs/scripts/create-workshop-copy.mjs YOUR-OWNER/my-ready-stacked-prs-workshop --ready --private
```
...
- `github/gh-stack`
- GitHub's `gh-stack` agent skill for the [GitHub Copilot CLI](https://github.com/features/copilot/cli) or [GitHub Copilot app](https://github.com/features/ai/github-app) workshop path
...
For the GitHub Copilot CLI path, run `copilot skill list` and confirm that `gh-stack` appears. In the GitHub Copilot app, confirm it under **Settings → Skills**.
